...
def visualize_detection(img, dets, is_show_label=True, classes=None, thresh=0.5):
    """
...
def visualize_detection_old(img, dets, is_show_label=True, classes=None, thresh=0.5, name='detection'):
    """
    visualize detections in one image
